...
class Google_Service_ServiceControl_Resource_Services extends Google_Service_Resource
{
   ...
   * executed.
   *
   * If feasible, the client should cache the check results and reuse them for up
   * to 60s. In case of server errors, the client may rely on the cached results
   * for longer time.
   *
   ...
   * reduce API traffic. Limiting aggregation to 5s is to reduce data loss during
   * client crashes. Clients should carefully choose the aggregation window to
   * avoid data loss risk more than 0.01% for business and compliance reasons.
   *
